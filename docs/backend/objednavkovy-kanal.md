...
**Frontend:** postavím `PublicOrderPage` + `usePublicOrders` po vzoru `usePublicBooking`, jakmile
budou tyhle 2 endpointy (nebo je postavím napřed a napojím). Menu i cena = **server je zdroj pravdy**.
