...
- **Audit POS/gastro akcí:** backend PR #169 zapisuje append-only audit přes `GET /api/v1/company/audit` pro storno prodeje, změnu slevy/spropitného na otevřeném gastro účtu a uzavření dne/Z-report. Frontend zatím nemá samostatnou audit UI stránku; roadmapa dál počítá s audit pokrytím změn cen a hotovostních korekcí.
