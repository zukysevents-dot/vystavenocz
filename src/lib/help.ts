...
export const HELP_GUIDES: readonly HelpGuide[] = [
  ...
  },
  {
    ...
    tip: 'Výdejka ani dodací list nejsou faktura. Nesrovnalost nemažte — popište ji; pohyby zásob jsou důležitá provozní historie.',
    to: '/app/skladove-doklady',
    action: 'Otevřít skladové doklady',
  },
  {
    id: 'purchase-orders',
    title: 'Objednejte a přijměte zboží bez zmatku',
    module: 'stock',
    audience: 'manager',
    description: 'Jednoduchá cesta od objednávky dodavateli ke skutečně potvrzené příjemce.',
    whatItMeans:
    ...
    action: 'Otevřít nákupní objednávky',
  },
  {
    id: 'workforce',
