...
<template>
  <section id="cenik" class="relative overflow-hidden bg-background py-16 sm:py-20">
    <div
      class="pointer-events-none absolute left-1/2 top-0 -z-10 aspect-square w-[120%] max-w-3xl -translate-x-1/2 -translate-y-1/3 rounded-full bg-aura opacity-20 blur-3xl"
      aria-hidden="true"
    />
    <div class="mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
      ...
      <p class="mt-6 text-sm text-muted-foreground">
        ...
        >
        · {{ MODULAR_PRICING.trialDays }} dní zdarma
      </p>
