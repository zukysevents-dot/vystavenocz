...
<template>
  ...
  >
    ...
    <section>
      <h2 class="text-2xl font-bold">2. Jaké údaje zpracováváme</h2>
      <h3 class="mt-4 text-lg font-semibold">Údaje o Uživateli (registrovaný účet)</h3>
      ...
      <h3 class="mt-4 text-lg font-semibold">Údaje o klientech Uživatele</h3>
      <ul class="ml-6 mt-2 list-disc space-y-1 text-muted-foreground">
    ...
    <section>
      <h2 class="text-2xl font-bold">3. Účely a právní základ zpracování</h2>
      <ul class="ml-6 mt-3 list-disc space-y-2 text-muted-foreground">
        <li>
          <strong>Plnění smlouvy</strong> (čl. 6 odst. 1 písm. b GDPR) — provoz služby, vystavování
          faktur, správa předplatného.
        </li>
        <li>
          <strong>Plnění zákonných povinností</strong> (čl. 6 odst. 1 písm. c) — vedení účetnictví
          dle zákona č. 563/1991 Sb., archivace daňových dokladů.
        </li>
        <li>
          <strong>Oprávněný zájem</strong> (čl. 6 odst. 1 písm. f) — zabezpečení služby, prevence
    ...
    <section>
      <h2 class="text-2xl font-bold">4. Doba uchování</h2>
    ...
    <section>
      <h2 class="text-2xl font-bold">6. Vaše práva</h2>
      <p class="mt-3 text-muted-foreground">V souladu s GDPR máte právo:</p>
      <ul class="ml-6 mt-3 list-disc space-y-1 text-muted-foreground">
        ...
        <li>
          podat stížnost u Úřadu pro ochranu osobních údajů (<a
