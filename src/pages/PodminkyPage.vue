...
<template>
  ...
  >
    ...
    <section>
      <h2 class="text-2xl font-bold">2. Předmět služby</h2>
      <p class="mt-3 text-muted-foreground">
        Vystaveno je webová aplikace pro vystavování, evidenci a správu faktur, zálohových faktur a
        dalších účetních dokladů určená především pro OSVČ, živnostníky a malé firmy v České
        republice. Služba zahrnuje:
      </p>
    ...
    <section>
      <h2 class="text-2xl font-bold">3. Registrace a uživatelský účet</h2>
      <p class="mt-3 text-muted-foreground">
        Pro využívání služby je nutná bezplatná registrace s platnou e-mailovou adresou. Uživatel je
        povinen uvádět pravdivé a aktuální údaje a chránit své přihlašovací heslo. Provozovatel
        neodpovídá za škody způsobené neoprávněným přístupem k účtu z důvodu prozrazení hesla
        Uživatelem.
      </p>
    </section>
    ...
    <section>
      <h2 class="text-2xl font-bold">6. Odstoupení od smlouvy</h2>
      <p class="mt-3 text-muted-foreground">
        Uživatel-spotřebitel má v souladu s § 1829 občanského zákoníku právo odstoupit od smlouvy do
        14 dnů od její uzavření. Aktivní využíváním placených funkcí (vystavení faktury, odeslání)
        Uživatel souhlasí s počátkem plnění před uplynutím této lhůty a bere na vědomí, že tím právo
        odstoupit zaniká dle § 1837 písm. l).
      </p>
    </section>

    <section>
      <h2 class="text-2xl font-bold">7. Práva a povinnosti Uživatele</h2>
      <p class="mt-3 text-muted-foreground">
        Uživatel se zavazuje službu nepoužívat k protiprávním účelům, zejména nikoli k vystavování
        fiktivních faktur, daňovým únikům či podvodům. Provozovatel je oprávněn účet Uživatele bez
        náhrady zablokovat při důvodném podezření na zneužití služby.
      </p>
      <p class="mt-3 text-muted-foreground">
        Za správnost údajů na vystavených fakturách (zejména DUZP, sazby DPH a náležitosti dle
        zákona č. 235/2004 Sb. o DPH) odpovídá výhradně Uživatel.
      </p>
    </section>

    <section>
      <h2 class="text-2xl font-bold">8. Dostupnost služby a omezení odpovědnosti</h2>
      <p class="mt-3 text-muted-foreground">
        Provozovatel usiluje o dostupnost služby 99,5 % měsíčně, negarantuje však nepřetržitý
        provoz. Provozovatel neodpovídá za škodu způsobenou ztrátou dat, výpadkem služby ani za
        následné škody Uživatele plynoucí z nemožnosti vystavit fakturu. Maximální výše náhrady
        škody je omezena na výši předplatného uhrazeného Uživatelem za posledních 12 měsíců.
      </p>
    </section>

    <section>
      <h2 class="text-2xl font-bold">9. Ochrana osobních údajů</h2>
      <p class="mt-3 text-muted-foreground">
    ...
    <section>
      <h2 class="text-2xl font-bold">10. Závěrečná ustanovení</h2>
      <p class="mt-3 text-muted-foreground">
        Vztahy neupravené těmito Podmínkami se řídí právním řádem České republiky, zejména zákonem
        č. 89/2012 Sb., občanským zákoníkem, a zákonem č. 634/1992 Sb. o ochraně spotřebitele.
        Případné spory bude rozhodovat věcně příslušný soud v České republice.
      </p>
      <p class="mt-3 text-muted-foreground">
      ...
      <p class="mt-3 text-muted-foreground">
        Provozovatel je oprávněn Podmínky kdykoliv změnit. O podstatných změnách informuje Uživatele
        e-mailem nejméně 14 dnů předem.
      </p>
    </section>
